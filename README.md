...
A simple and responsive **HTML & CSS based static website** showcasing landscape photography.
This project demonstrates clean UI design, basic web structure, and styling using pure CSS.
...
├── landscape.jpg     # Landscape image
├── newland.jpg       # Landscape image
├── photo.jpg         # Photography image
```
